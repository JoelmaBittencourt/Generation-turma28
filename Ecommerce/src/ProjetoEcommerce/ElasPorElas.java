...
char ProximoCliente;
      ...
      produtos.add(new Produtos(6,"   Leave in         ","produto artesanal para cabelos ondulados             ",25.00 ,30));
  ...
  System.out.print("Onde 20% do nosso lucro são destinados a mulheres pretas e peeoas em situação vulneraveis,juntes somos mais fortes!!!\n");
  ...
  System.out.println( "todos os produtos sao produzidos por nós,da embalagem a mercadoria,quer mais informaçoes? digite www.elasporelas.com.br \n");
  //NOME E CPF
  System.out.println("Digite o seu nome");
  nota.setNomeCliente(leia.nextLine());
...
//PRA DAR ERRO SE NAO DIGITAR 11 NUMEROS DO CPF
 ...
 continuar=leia.next().toUpperCase().charAt(0);
    ...
    System.out.println("digite [5] para doar seu desconto de 10% no valor das suas compras para a nossa causa e pagar a vista");
    int resposta=leia.nextInt();
    // CONTA DAS OPÇOES DE PAGAMENTO DO CARRINHO COMO DESCONTOS,FORMAS DE PGTO E PARCELAS
    if(resposta==1) {
    double valor=0.80;
