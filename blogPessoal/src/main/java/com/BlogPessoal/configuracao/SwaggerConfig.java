package com.BlogPessoal.configuracao;
...
public class SwaggerConfig
{
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.BlogPessoal.controladores")).paths(PathSelectors.any())
	...
	public static ApiInfo metadata()
	{
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/JoelmaBittencourt")
				.contact((Contact) contact()).build();
	}

	private static Contact contact()
	{
		return new Contact("Joelma Bittencourt", "https://github.com/JoelmaBittencourt", "joelma.izaltina@gmail.com");
	}
